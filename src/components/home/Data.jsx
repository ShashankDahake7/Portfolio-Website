    ...
    return (
        <div className="home__data">
            ...
            <p className="home__description">
                I am a Full Stack Developer skilled in React, TypeScript, TailwindCSS, Node.js, Express, MongoDB, and PostgreSQL. I specialize in building scalable, user-focused web applications with efficient APIs and seamless integrations.
            </p>
